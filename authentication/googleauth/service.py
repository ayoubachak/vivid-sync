...
class GoogleAccessTokens:
    ...
    def decode_id_token(self, client_id: str) -> Dict[str, str]:
        ...
        decoded_token = jwt.decode(jwt=id_token, audience=client_id, options={"verify_signature": False})
        return decoded_token


class GoogleRawLoginFlowService:
    # API_URI = reverse_lazy("authentication:login-raw:callback-raw")
    API_URI = "api/auth/google-oauth2/login/callback/"
