...
const VerifyEmail: React.FC = () => {
    ...
    const handleChangeEmail = async () => {
        try {
            const response = await axiosInstance.post('/api/change-email/', { newEmail });
            ...
            setErrorMessage('Failed to change email. Please try again.');
        }
    };
    ...
    return (
        <div className="light">
            ...
            <div className="verification-form">
                ...
                <p className="resend">
                    If you did not receive the Email, <button onClick={handleResendCode} className="text-blue-600 hover:text-blue-800">Resend the Code</button>
                    {!email && (
                        <button onClick={() => setShowEmailChangeForm(true)} className="ml-2 text-blue-600 hover:text-blue-800">
                            Add Email
                        </button>
                    )}
                    {email && (
